!!****if* source/physics/Eos/EosMain/multiTemp/Helmholtz/eos_vecData
!!
!! NAME
!!
!!  eos_vecData
...
! UNUSED       &                             dsaRow,dszRow
  ...
  real, dimension(NROWMAX), save ::    cvIonRow,cvEleRow
...
! UNUSED       &                             dsaRow,dszRow
  ...
  real, allocatable, dimension(:), save ::    cvIonRow,cvEleRow

  real, allocatable, dimension(:,:), save ::    eCompRow, pcompRow

#endif

  target :: etotRow,ptotRow
