!!****if* source/physics/Eos/EosMain/multiTemp/Helmholtz/SpeciesBased/Eos_vectorBased
!!
!! NAME
!!
!! Eos
...
#include "Multispecies.h"
  ...
  if (mode==MODE_DENS_TEMP) then
     ...
     call eos_helm(vecBegin,vecEnd,runAll,mask)
     ...
     ! Loop over newton iterations now
        do i = 2, eos_maxNewton
           ...
           call eos_helm(vecBegin,vecEnd,error,mask)
