!!****if* source/physics/Eos/EosMain/multiTemp/Gamma/eos_vecDealloc
!!
!! NAME
!!
!!  eos_vecDealloc
...
#include "Flash.h"
  ...
  if (.NOT. allocated(tempRow)) return ! RETRUN immediately!
...
!..derivative based quantities
  ...
  deallocate(tempRadRow)
  deallocate(tempIonRow)
  deallocate(tempEleRow)
  deallocate(eCompRow)
  deallocate(pCompRow)
#endif
