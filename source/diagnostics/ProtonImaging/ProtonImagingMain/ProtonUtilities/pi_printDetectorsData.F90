!!****if* source/diagnostics/ProtonImaging/ProtonImagingMain/ProtonUtilities/pi_printDetectorsData
!!
!! NAME
!!
...
#include "Flash.h"
  ...
  real    :: cornerLLX, cornerLLY, cornerLLZ
  real    :: cornerLRX, cornerLRY, cornerLRZ
  real    :: cornerULX, cornerULY, cornerULZ
  real    :: cornerURX, cornerURY, cornerURZ
  real    :: dist2BC
  real    :: maxDev
  real    :: nx, ny, nz
...
!
  do detector = 1, pi_numberOfDetectors
     ...
     cornerLLX     = pi_detectors (detector) % cornerLowerLeftX
     cornerLLY     = pi_detectors (detector) % cornerLowerLeftY
     cornerLLZ     = pi_detectors (detector) % cornerLowerLeftZ
     cornerLRX     = pi_detectors (detector) % cornerLowerRightX
     cornerLRY     = pi_detectors (detector) % cornerLowerRightY
     cornerLRZ     = pi_detectors (detector) % cornerLowerRightZ
     cornerULX     = pi_detectors (detector) % cornerUpperLeftX
     cornerULY     = pi_detectors (detector) % cornerUpperLeftY
     cornerULZ     = pi_detectors (detector) % cornerUpperLeftZ
     cornerURX     = pi_detectors (detector) % cornerUpperRightX
     cornerURY     = pi_detectors (detector) % cornerUpperRightY
     cornerURZ     = pi_detectors (detector) % cornerUpperRightZ
     ...
     write (fileUnit,'(a,es20.12)') " Lower left  corner global x-coordinate         = ", cornerLLX
     write (fileUnit,'(a,es20.12)') " Lower left  corner global y-coordinate         = ", cornerLLY
     write (fileUnit,'(a,es20.12)') " Lower left  corner global z-coordinate         = ", cornerLLZ
     write (fileUnit,'(a,es20.12)') " Lower right corner global x-coordinate         = ", cornerLRX
     write (fileUnit,'(a,es20.12)') " Lower right corner global y-coordinate         = ", cornerLRY
     write (fileUnit,'(a,es20.12)') " Lower right corner global z-coordinate         = ", cornerLRZ
     write (fileUnit,'(a,es20.12)') " Upper left  corner global x-coordinate         = ", cornerULX
     write (fileUnit,'(a,es20.12)') " Upper left  corner global y-coordinate         = ", cornerULY
     write (fileUnit,'(a,es20.12)') " Upper left  corner global z-coordinate         = ", cornerULZ
     write (fileUnit,'(a,es20.12)') " Upper right corner global x-coordinate         = ", cornerURX
     write (fileUnit,'(a,es20.12)') " Upper right corner global y-coordinate         = ", cornerURY
     write (fileUnit,'(a,es20.12)') " Upper right corner global z-coordinate         = ", cornerURZ
