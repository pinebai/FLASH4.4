!!****if* source/diagnostics/ProtonImaging/ProtonImagingMain/oldOneTimeStep/ProtonsCreate/pi_createProtonTags
!!
!! NAME
!!
!!  pi_createProtonTags
...
!!
!!     4) Time step global unique tag assignment --> Assign consecutive tag values
!!        starting from 1 for all protons created during the present time step
!!        cycle on all processors for the current batch. This is simply done
!!        by adding the value of the previous tag start value. After this step
!!        has been done, the maximum tag value is updated by all protons generated
